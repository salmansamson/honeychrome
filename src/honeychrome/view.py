...
class View(QObject):
    ...
    def _connect_signals(self):
        ...
        self.bus.spilloverChanged.connect(self.controller.initialise_data_for_cytometry_plots)
        ...
        self.bus.spilloverChanged.connect(lambda: self.bus.autoSaveRequested.emit())
