...
<li><b>Review:</b> fluorophore profiles, similarity matrix and HotSpot Matrices.</li>
<li><b>Inspect the NxN plots:</b> check for any remaining unmixing issues, and fine-tune the spillover matrix if needed.</li>
