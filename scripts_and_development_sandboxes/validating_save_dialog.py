...
class ValidatingSaveDialog(QFileDialog):
    def __init__(self, parent=None, caption="Save File", directory="", filter="All Files (*)"):
...
if __name__ == "__main__":
    ...
    dlg = ValidatingSaveDialog(
        caption="Save a New File",
        directory=str(Path.home()),
        filter="Glowstick Files (*.kit);;All Files (*)"
    )
